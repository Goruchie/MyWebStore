            ...
            <div class="d-flex justify-content-center row">
                ...
                <div class="d-flex justify-content-center row m-2">
                    ...
                    <div class="card col-2 m-2">
                        <a href="Explore.aspx" class="img-wrapper">
                    ...
                    <asp:Button ID="btnLExplore" Text="Let's explore" OnClick="btnLExplore_Click" CssClass="btn btn-secondary exp-btn col-2" runat="server" />
